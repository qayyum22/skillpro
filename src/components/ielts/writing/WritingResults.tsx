            ...
            <Card className="mb-6">
                <CardContent className="p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-gray-700">{results[currentTask].prompt}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="bg-white p-4 rounded-lg border border-gray-200">
                                <p className="text-gray-700 whitespace-pre-wrap">
                                    {results[currentTask].userAnswer}
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-white p-4 rounded-lg border border-gray-200">
                                <p className="text-gray-700 whitespace-pre-wrap">
                                    {results[currentTask].modelAnswer}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Badge className={`text-lg ${getBandColor(results[currentTask].feedback.score)}`}>
                                {results[currentTask].feedback.score}
                            </Badge>
                        </div>
                    </div>

                    <p className="text-gray-700 mb-6">{results[currentTask].feedback.content}</p>

                    {/* Scoring Breakdown */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {Object.entries(results[currentTask].feedback.breakdown).map(([criterion, score]) => (
                            <div key={criterion} className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
