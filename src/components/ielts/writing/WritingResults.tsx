...
const WritingResults = ({ evaluationResults }: { evaluationResults: any }) => {
                ...
                <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="bg-white p-4 rounded-lg border border-gray-200">
                                <p className="text-gray-700 whitespace-pre-wrap">
                                    {evaluationResults[currentTask].userAnswer}
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="bg-white p-4 rounded-lg border border-gray-200">
                                <p className="text-gray-700 whitespace-pre-wrap">
                                    {evaluationResults[currentTask].modelAnswer}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <CardContent className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Badge className={`text-lg ${getBandColor(evaluationResults[currentTask].feedback.score)}`}>
                                {evaluationResults[currentTask].feedback.score}
                            </Badge>
                        </div>
                    </div>
