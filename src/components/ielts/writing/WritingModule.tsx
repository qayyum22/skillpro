        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-4 mb-6">
            <button
              ...
              className={`px-4 py-2 rounded ${category === 'academic'
            ...
            <button
              ...
              className={`px-4 py-2 rounded ${category === 'general'
                  ? 'bg-blue-500 text-white'
                  : 'bg-gray-200 text-gray-800 hover:bg-gray-300'
                }`}
            >
            ...
            tests.map(test => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 mb-2">
                  {test.category ? test.category.charAt(0).toUpperCase() + test.category.slice(1) : 'Unknown'} Writing Test
                </p>
                <p className="text-xs text-gray-500">
                  {test.tasks ? test.tasks.length : 0} tasks | Created: {new Date(test.createdAt).toLocaleDateString()}
                </p>
              </div>
            ))
          )}
            ...
            {selectedTest.tasks.map((task, index) => (
              <div key={index} className="border-l-4 border-blue-500 pl-4">
                ...
                <p className="text-sm text-gray-600">
                  Time: {task.timeGuide} | Word limit: {(task as IELTSWritingTask).wordLimit}
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="text-sm text-gray-600 mb-4">
              ...
              {'wordLimit' in currentTask && <div>Word Count: {currentTask.wordLimit}</div>}
            </div>
