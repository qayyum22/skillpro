...
//         wordLimit: "Minimum 150 words",
//         tips: [""],
//         partType: "part1", // Added missing property
//       });
//       setTask2({
//         taskType: "task2",
//         title: "",
...
//         wordLimit: "Minimum 250 words",
//         tips: [""],
//         partType: "part2", // Added missing property
//         timeGuide: "40 minutes",
//         wordLimit: "Minimum 250 words",
//         // Removed duplicate properties and fixed the syntax
...
const AddTest = () => {
  ...
  const handleAddTest = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const err = error as Error;
      toast.error(err.message || "Error adding test");
      Analytics.track("test_creation_failed", {
        error: err.message,
        category,
      });
    } finally {
        ...
        <form onSubmit={handleAddTest} className="space-y-6">
          <div>
            ...
            <select
              ...
              value={category}
              onChange={(e) =>
                setCategory(e.target.value as IELTSWritingCategory)
              }
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            >
              <option value="academic">Academic</option>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  value={task1.description}
                  onChange={(e) =>
                    setTask1({ ...task1, description: e.target.value })
                  }
                  required
                  rows={5}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={task1.timeGuide}
                    onChange={(e) =>
                      setTask1({ ...task1, timeGuide: e.target.value })
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={task1.wordLimit}
                    onChange={(e) =>
                      setTask1({ ...task1, wordLimit: e.target.value })
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  />
                </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  value={task2.description}
                  onChange={(e) =>
                    setTask2({ ...task2, description: e.target.value })
                  }
                  required
                  rows={5}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={task2.timeGuide}
                    onChange={(e) =>
                      setTask2({ ...task2, timeGuide: e.target.value })
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    value={task2.wordLimit}
                    onChange={(e) =>
                      setTask2({ ...task2, wordLimit: e.target.value })
                    }
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  />
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-500">
                  Category: <span className="capitalize">{currentTest.category}</span> | Created:{" "}
              ...
              <div className="mt-6 space-y-6">
                {currentTest.tasks.map((task, index) => (
                  <div key={index} className="border-t pt-4">
                    <h3 className="font-medium text-lg">{'title' in task ? task.title : 'N/A'}</h3>
                    <p className="mt-2 whitespace-pre-line">{'description' in task ? task.description : 'N/A'}</p>

                    <div className="grid grid-cols-2 gap-4 mt-4 text-sm">
                      <div>
                        <span className="font-medium">Time Guide:</span>{" "}
                        {task.timeGuide}
                      </div>
                      <div>
                        <span className="font-medium">Word Limit:</span>{" "}
                        {('wordLimit' in task) ? task.wordLimit : 'N/A'}
                      </div>
                      <h4 className="font-medium text-sm">Tips for Students:</h4>
                      <ul className="list-disc pl-5 mt-1 text-sm">
                        {task.tips.map((tip, tipIndex) => (
