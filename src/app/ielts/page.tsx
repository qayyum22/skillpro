...
const Dashboard: React.FC = () => {
  ...
  const modules = [
    {
      title: 'Full IELTS Test - Academic',
    ...
    },
    {
      ...
      description: 'Improve comprehension skills with general texts and passages',
      icon: BookOpen,
      bgColor: 'bg-emerald-600',
      onClick: () => setActiveModule('reading')
    },
  ...
  if(activeModule === 'full-test'){
    router.push('/ielts/fulltest');
  }

  if(activeModule === 'reading'){
    router.push('/ielts/reading');
  }
